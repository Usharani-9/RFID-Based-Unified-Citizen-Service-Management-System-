...
| `0x0010 - 0x0011` | User 1 (Pooja) ATM Balance (16-bit) | `10000` |
| `0x0012 - 0x0013` | User 2 (Madhu) ATM Balance (16-bit) | `450` |
| `0x0014 - 0x0015` | User 3 (Nikki) ATM Balance (16-bit) | `5000` |
